...
# Палитра проверена на контраст к фону карточки #1c1f26 по WCAG: у всего
# текста не меньше 4.5:1. Прежние приглушённые серые давали 2.5-3.7:1 —
# подписи и перевод примера буквально сливались с фоном.
C_BG        = "#1c1f26"
C_WORD      = "#ffffff"     # 16.5:1
C_IPA       = "#8fdaff"     # 10.9:1
C_TRANS     = "#ffd98a"     # 12.2:1
C_EXAMPLE   = "#d3d9e4"     # 11.6:1
C_EXAMPLE_RU= "#9aa5b8"     #  6.6:1
C_META      = "#8b94a6"     #  5.4:1
C_FORM_TAG  = "#98a1b2"     #  6.3:1
C_FORM_IPA  = "#84a9bd"     #  6.6:1
C_MODE      = "#a3adbd"     #  7.3:1
C_LINK_HOVER= "#ffd98a"
